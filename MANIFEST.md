...
| spark-web | 0.1.0 | Browser dashboard for the Spark AI sidekick. Embeds a Pi agent session in the Manifest server and serves a real-time web UI for interacting with Spark. |
